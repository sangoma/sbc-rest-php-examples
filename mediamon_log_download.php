...
$module_name = 'mediamon';
$obj_type = 'log';
$obj_name = 'mediamon.log';
...
http://10.10.2.132/SAFe/sng_rest/api/download/mediamon/log/mediamon.log 
result : file size = 1276
